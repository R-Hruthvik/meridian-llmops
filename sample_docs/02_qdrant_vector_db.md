# Local Quickstart
> 原文链接: https://qdrant.tech/documentation/quickstart/
...
The results are returned in decreasing similarity order. Note that payload and vector data is missing in these results by default. See [payload and vector in the result](https://qdrant.tech/documentation/search/search/#payload-and-vector-in-the-result) on how to enable it.
